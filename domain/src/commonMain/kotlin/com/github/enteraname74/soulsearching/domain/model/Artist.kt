...
import com.github.enteraname74.soulsearching.domain.util.serializer.InstantSerializer
    ...
    fun merge(
        ...
        when (mergeMode) {
            MergeMode.LocalFirst -> copy(
                ...
                cover = cover?.takeIf { !it.isEmpty() } ?: cloudArtist.coverPath?.let { Cover.Url(it, null) },
            )
