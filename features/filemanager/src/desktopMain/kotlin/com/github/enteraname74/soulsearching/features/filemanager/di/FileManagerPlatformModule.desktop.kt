...
import com.github.enteraname74.soulsearching.features.filemanager.cloud.CloudCacheManagerDesktopImpl
...
internal actual val fileManagerPlatformModule: Module = module {
    ...
    singleOf(::CloudCacheManagerDesktopImpl) bind CloudCacheManager::class
}