...
class SettingsCloudSharedListJoinViewHolder(
    private val savedStateHandle: SavedStateHandle,
    private val joinSharedPlayedListUseCase: JoinSharedPlayedListUseCase,
    private val loadingManager: LoadingManager,
    private val feedbackPopUpManager: FeedbackPopUpManager,
) : SoulViewModelHolder<
        SettingsCloudSharedListJoinActions,
            SettingsCloudSharedListJoinNavScope,
            SettingsCloudSharedListJoinState>(
        initialState = SettingsCloudSharedListJoinState(
    ...
    override val actions: SettingsCloudSharedListJoinActions = this
    ...
    override fun Content(
        ...
        SettingsCloudSharedListJoinScreen(
            actions = actions,
            state = state,
        )
    }
