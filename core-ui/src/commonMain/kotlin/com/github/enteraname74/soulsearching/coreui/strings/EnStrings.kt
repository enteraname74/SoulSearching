...
object EnStrings : Strings {
    ...
    override val cloudSignInCodeTitle = "Generate an inscription code"
    override val cloudSignInCodeText = "Generate a code to let your friends create an account on your cloud instance."
    override val cloudSignInCodeButton = "Generate a code"
    override val cloudSignInScanCode = "Scan an inscription code"
    override val cloudSignInScanPermissionTitle = "Missing required permission!"
    override val cloudSignInScanPermissionText = "You must accept camera permission for the QR code scanner to work."
