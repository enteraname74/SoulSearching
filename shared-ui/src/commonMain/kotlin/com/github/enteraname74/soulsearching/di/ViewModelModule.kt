...
import com.github.enteraname74.soulsearching.feature.settings.managemusics.managefolders.domain.SettingsAllFolderViewModel
...
internal val viewModelModule: Module = module {
    ...
    singleOf(::SettingsAllFolderViewModel)
    ...
    // Other
    singleOf(::SoulSearchingSettingsImpl)
